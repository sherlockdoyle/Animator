...
path_effects: list[tuple[am.skia.PathEffect, str]] = [
    ...
    (
        am.skia.MergePathEffect.Make(
            am.skia.CornerPathEffect.Make(50), am.skia.DiscretePathEffect.Make(10, 4), am.skia.PathOp.kXOR_PathOp
        ),
        'MergePathEffect-XOR',
    ),
    (
    ...
    (am.skia.TrimPathEffect.Make(0.25, 0.75, am.skia.TrimPathEffect.Mode.kInverted), 'TrimPathEffect'),
    (am.skia.DashPathEffect.Make([4, 8, 12, 20]), 'DashPathEffect'),
    (
        am.skia.MergePathEffect.Make(
            am.skia.CornerPathEffect.Make(50),
            am.skia.DiscretePathEffect.Make(10, 4),
            am.skia.PathOp.kReverseDifference_PathOp,
        ),
        'MergePathEffect-ReverseDifference',
    ),
    (
        am.skia.Path1DPathEffect.Make(small_path, 20, 0, am.skia.Path1DPathEffect.Style.kRotate_Style),
        'Path1DPathEffect-Rotate',
    ),
    (am.skia.MatrixPathEffect.Make(am.skia.Matrix.Scale(0.5, 1)), 'MatrixPathEffect'),
    ...
    (am.skia.StrokeAndFillPathEffect.Make(), 'StrokeAndFillPathEffect'),
    (
        am.skia.StrokePathEffect.Make(10, am.skia.Paint.Join.kRound_Join, am.skia.Paint.Cap.kRound_Cap),
        'StrokePathEffect',
    ),
